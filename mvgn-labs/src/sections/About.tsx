...
const About: React.FC = () => {
  return (
    ...
    >
      ...
      {/* Main Content Grid */}
      <div className="grid-system grid-1 lg:grid-2 items-center gap-8 lg:gap-12">
        ...
        >
          <div className="relative">
            ...
            >
              {/* Marco principal circular */}
              <div className="relative w-full h-full bg-gradient-to-br from-surface-primary to-surface-secondary backdrop-blur-md rounded-2xl p-3 sm:p-4 border border-border-primary shadow-2xl">
              ...
              <div className="absolute inset-0 rounded-2xl">
                ...
                <div className="absolute inset-2 rounded-2xl border border-border-secondary/20" />
                <div className="absolute inset-4 rounded-2xl border border-border-primary/20" />
              </div>
            </motion.div>
          </div>
        </motion.div>
        ...
        >
          {/* Description - Máximo 2 párrafos cortos */}
