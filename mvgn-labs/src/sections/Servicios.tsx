    ...
    <section className="section relative overflow-hidden">
      ...
      <div className="container relative z-10">
              ...
              >
                <div className={`${service.bgColor} ${service.borderColor} border-2 rounded-3xl p-8 h-full transition-all duration-300 hover:scale-105 hover:shadow-2xl ${
                  ...
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                      <h3 className="text-2xl font-fraunces font-semibold text-text-primary mb-1">
                        {service.title}
                      </h3>
                  ...
                  {/* Características */}
                  <div className="mb-6">
                    <h4 className="text-text-primary font-semibold mb-3 text-base">Características:</h4>
                  ...
                  {/* Beneficios */}
                  <div className="mb-6">
                    <h4 className="text-text-primary font-semibold mb-3 text-base">Beneficios:</h4>
        ...
        >
          ...
          {/* Grid de Tecnologías */}
          <div className="grid-system grid-4 mb-16">
            {technologyGroups.map((group, index) => (
              ...
              >
                <div className={`bg-gradient-to-br from-surface-primary to-surface-secondary backdrop-blur-sm border-2 rounded-2xl p-6 h-full transition-all duration-300 hover:scale-105 ${
                  ...
                  <div className={`w-16 h-16 bg-gradient-to-br ${group.color} rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform`}>
                    <group.icon className="icon-xl text-white" />
                  </div>
                  <h4 className="text-text-primary font-semibold text-center mb-2 text-base">{group.title}</h4>
                  <p className="text-text-tertiary text-sm text-center mb-3">{group.description}</p>
          ...
          {selectedTech && (
            <motion.div
              ...
              className="bg-gradient-to-br from-surface-primary to-surface-secondary backdrop-blur-md border border-border-primary rounded-3xl p-8 max-w-4xl mx-auto"
            >
              ...
              <div className="grid-system grid-2 gap-4">
                {technologyGroups
                  ...
                  ?.technologies.map((tech, index) => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-text-primary font-medium text-base">{tech}</span>
                      </div>
                    </motion.div>
                  ))}
              </div>
