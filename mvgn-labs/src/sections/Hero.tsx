  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden bg-bg-primary">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        />
        <motion.div
          className="absolute bottom-20 -left-20 w-80 h-80 bg-primary-light/5 rounded-full blur-3xl"
          animate={{
            scale: [1.1, 1, 1.1],
            opacity: [0.5, 0.3, 0.5],
          }}
        ...
        <div className="flex items-center justify-center min-h-screen">
          ...
          >
            ...
            <motion.div
              ...
              className="space-y-6"
            >
              <p className="text-2xl md:text-3xl lg:text-4xl text-primary font-semibold tracking-wide">
                ¡Hola! Soy
              </p>
              <h1 className="text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-fraunces font-bold text-text-primary leading-tight">
                Armando{' '}
