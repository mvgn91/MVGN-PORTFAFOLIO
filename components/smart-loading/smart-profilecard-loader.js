...
class SmartProfileCardLoader {
  ...
  loadMobileOptimizedVersion(container) {
    ...
    this.loadCSS('components/profilecard/profilecard-mobile-optimized.css');
    
    // Cargar JavaScript móvil optimizado
    this.loadJS('components/profilecard/profilecard-mobile-optimized.js', () => {
  ...
  loadTabletOptimizedVersion(container) {
    ...
    this.loadCSS('components/profilecard/profilecard-desktop.css');
    
    this.loadJS('components/profilecard/profilecard-desktop.js', () => {
  ...
  loadDesktopVersion(container) {
    ...
    this.loadCSS('components/profilecard/profilecard.css');
    
    this.loadJS('components/profilecard/profilecard.js', () => {
